...
````
    <!-- Widget tag -->
    <indigenius-convai id="convai-widget"></indigenius-convai>

    <!-- SDK script -->
    <script type="module" src="https://cdn.jsdelivr.net/npm/indigenius-ai-widget/dist/index.js"></script>
...
<CardGroup cols={1}>
  <Card title="Tip" icon="lightbulb" iconType="solid" color="#FACC15">
    ✅ Use <code>mountUI: true</code> for quick integration.<br />
    ✅ Use <code>mountUI: false</code> for custom UI.<br />
