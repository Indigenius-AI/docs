...
<CardGroup cols={2}>
  ...
  <Card title="Server URLs" icon="server" iconType="solid" color="#F79320" iconSize={40}>
   ...
   <Card title="Privacy" icon="shield" iconType="solid" color="#F79320" iconSize={40}>
...
<CardGroup cols={2}>
 ...
 <Card title="Indigenius Flutter" icon="flutter" iconType="brands" color="#F79320" iconSize={40}>
