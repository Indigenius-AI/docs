...
<CardGroup cols={2}>
 ...
 <Card title="Text-To-Speech (TTS)" icon="volume-2" iconType="outline" color="#F79320" iconSize={40}>
...
<CardGroup cols={2}>
  ...
  <Card title="Server URLs" icon="server" iconType="solid" color="#F79320" iconSize={40}>
   ...
   <Card title="Phone Calling" icon="phone-call" iconType="outline" color="#F79320" iconSize={40}>
    Learning the ins-and-outs of telephony & conducting phone calls on Indigenius.
  </Card>
  
 <Card title="Privacy" icon="shield" iconType="outline" color="#F79320" iconSize={40}>
...
<CardGroup cols={2}>
  ...
  <Card title="Indigenius Flutter" icon="smartphone" iconType="outline" color="#F79320" iconSize={40}>
