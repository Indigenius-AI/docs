...
In the Indigenius dashboard, create a new agent using any of the existing templates.

![Createyour Agent Gi](/images/CreateyourAgent.gif)
...
### **Make an inbound call (call your agent)**

1. **Call your agent in the dashboard**

Try calling your agent by clicking the “Talk to agent ” button in the dashboard.

(image of agent making inbound call)
...
- Select your prefered region and prefeed number and proceed to make payment.
- Assign your prefered agent fot inbound or outbound call.

  ![Untitleddesign Gi](/images/Untitleddesign.gif)

                                            (image showing the purchase phone number gif)
...
![Assign Agent Gi](/images/AssignAgent.gif)
                                                   ...
                                                   (image of selecting an agent for inbound call)

### **Make an outbound call (agent calls you)**
...
(Screen showing the outbound call process)
