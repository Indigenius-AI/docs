...
### 1. Create an Agent
From your **Indigenius dashboard**, [create a new agent](https://cdialai-0073e50a.mintlify.app/AgentPro/Quickstart#2-create-your-agent) or select an existing agent and assign it as the agent for your widget.  
